  ...
  return (
    <>
      <body class="w-full bg-black">
        ...
        <div class=" w-full h-20 flex justify-center flex-row items-center space-x-12 space-y-[200px] mb-[150px]">
          <img src="/epic.png" alt="" width={50} height={100} class="-mb-[200px]" />
        ...
        <section class="w-full flex justify-center">
          <div class="bg-black w-[80%] flex flex-row justify-between">
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-row justify-center items-center gap-10 mb-7">
                <div class=" -mb-2">
              ...
              <div class="flex flex-row justify-center items-center gap-11 mb-7">
                <div class=" -mb-2">
