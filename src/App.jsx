function App() {
  ...
  return (
    <>
     ...
     <div class= "bg-gray-300 p-5 space-y-1">
     
     <div class= "text-orange-400 flex justify-start fixed text-xl font-bold">24H Shop</div>
     
     <div class= "flex justify-end space-x-4 text-sm relative">
